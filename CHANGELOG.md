...
### Changed
- **2026-08-14 00:10:00 +08:00** · **Chan** (`@xxch4nnn`) — Issue #95 slim slice: additive `documents.date_issued`, `DocumentObserver` → `audit_logs.record_*` (no `Auth::id() ?? 2`), tests; does not merge #92/#87/#68; file editor UI still 501 (PR-E).
