...
| [#94](https://github.com/xxch4nnn/DOST-S-T-SECTION-PROJECT/issues/94) Path A merge Dependabot #88–#91 + re-pin TECH_STACK_DOCS | `@xxch4nnn` | B — deps | ⏳ **ready to merge, blocked on PR creation permissions** — `cursor/chore-deps-path-a-94-fc09` @ `fe2af7f`; leave OPEN. Compare: https://github.com/xxch4nnn/DOST-S-T-SECTION-PROJECT/compare/master...cursor/chore-deps-path-a-94-fc09?expand=1 |
| [#95](https://github.com/xxch4nnn/DOST-S-T-SECTION-PROJECT/issues/95) Slim `date_issued` + DocumentObserver delta (supersede #92/#87/#68) | `@WakenMac` / Chan | C — backend | ⏳ **ready to merge, blocked on PR creation permissions** — `cursor/feat-be-95-date-issued-observer-fc09` @ `89343d3`; leave OPEN; **do not merge #92/#87/#68**. Compare: https://github.com/xxch4nnn/DOST-S-T-SECTION-PROJECT/compare/master...cursor/feat-be-95-date-issued-observer-fc09?expand=1 |
