...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('scholars.index')" :active="request()->routeIs('scholars.*')" wire:navigate>
                {{ __('Scholars') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin-records.index')" :active="request()->routeIs('admin-records.*')" wire:navigate>
                {{ __('Admin Records') }}
            </x-responsive-nav-link>
            @can('viewAuditLogs')
