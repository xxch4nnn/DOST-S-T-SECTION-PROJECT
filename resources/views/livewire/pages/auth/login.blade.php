    ...
    <form wire:submit="login">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="form-check mb-0">
                ...
                <label for="remember" class="form-check-label text-secondary small">{{ __('Remember me') }}</label>
            </div>
            @if (Route::has('password.request'))
                <a class="small text-decoration-none text-muted" href="{{ route('password.request') }}" wire:navigate>
