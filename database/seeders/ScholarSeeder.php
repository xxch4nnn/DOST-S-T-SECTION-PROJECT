    ...
    public function run(): void
    {
        $groups = [
            [
                ...
                'last_name'  => "Maclang", 
                'year_of_award' => 2023, 
                'scholarship_program_id' => ScholarshipProgram::where('name', 'DOST-SEI Merit')->first()->id, 
                'scholarship_program_type_id' => ScholarshipProgramType::where('name', 'DOST-SEI Undergraduate Scholarship')->first()->id, 
                'spas_number'=>"U-2023-11-09419", 
                'sex'=>"Male", 
            ...
            [
                ...
                'last_name'  => "Fernandez", 
                'year_of_award' => 2023, 
                'scholarship_program_id' => ScholarshipProgram::where('name', 'DOST-SEI RA 7687')->first()->id, 
                'scholarship_program_type_id' => ScholarshipProgramType::where('name', 'DOST-SEI Undergraduate Scholarship')->first()->id, 
                'spas_number'=>"U-2023-XX-XXXXX", 
                'sex'=>"Male", 
